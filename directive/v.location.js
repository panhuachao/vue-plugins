/**
 * Created by Dev02 on 2016/4/20.
 */
(function () {
    Vue.directive('location', {
        twoWay: true, //设定双向绑定
        deep: true,
        params: ['type'], //类型,province, city, district
        bind: function () {
            // 准备工作
        ...
        update: function (obj) {
            ...
            switch(this.params.type)
            {
                case "province":
                    ...
                    for(var i=0;i<citydata.length;i++)
                    {
                        ...
                        if(citydata[i].name==g_obj["province"])
                        {
                ...
                case "city":
                    ...
                    for(var i=0;i<citydata.length;i++)
                    {
                        if(g_obj["province"]==citydata[i].name)
                        {
                            citys=citydata[i].city;
                            break;
                        }
                    }
                    if(citys==undefined)
                    ...
                    {
                        var option=new Option(citys[i].name, citys[i].name);
                        if(citys[i].name==g_obj["city"])
                        {
                            option.selected=true;
                            cityselected=true;
                        }
                    ...
                    if(cityselected==false)
                    {
                        ...
                        g_obj[this.params.type]=this.el.options[0].value;
                    }
                    break;
                case "district":
            ...
            this.handler = function () {
                ...
                // 它将用给定值设置 `vm.a.b.c`
                g_obj[this.params.type]=this.el.value;
                this.set(g_obj);
            }.bind(this);
